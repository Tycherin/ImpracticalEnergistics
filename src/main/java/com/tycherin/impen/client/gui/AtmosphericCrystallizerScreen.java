...
public class AtmosphericCrystallizerScreen extends UpgradeableScreen<AtmosphericCrystallizerMenu> {

    private final ProgressBar prog;

    public AtmosphericCrystallizerScreen(final AtmosphericCrystallizerMenu menu, final Inventory playerInventory,
