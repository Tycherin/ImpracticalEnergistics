...
public class IsmCatalystRecipeCategory implements IRecipeCategory<IsmCatalystRecipe> {

    private static final String TITLE_TRANSLATION_KEY = "gui.impracticalenergistics.jei.ism_recipe_title";
    ...
    public static final ResourceLocation UID = new ResourceLocation(ImpracticalEnergisticsMod.MOD_ID, "ism_catalyst");

    private final IDrawable background;
    private final IDrawable icon;

    public IsmCatalystRecipeCategory(final IGuiHelper guiHelper) {
    ...
    @Override
    public void setRecipe(final IRecipeLayoutBuilder layoutBuilder, final IsmCatalystRecipe recipe,
    ...
    @Override
    public void draw(final IsmCatalystRecipe recipe, final IRecipeSlotsView recipeSlotsView, final PoseStack stack,
    ...
    private static interface OutputBoxOperator {
        void handleOutputBox(final IsmWeight weight, final int xPos, final int yPos);
    }

    private void forEachOutput(final List<IsmWeight> weights, final OutputBoxOperator func) {
    ...
    @Override
    public Class<? extends IsmCatalystRecipe> getRecipeClass() {
        return IsmCatalystRecipe.class;
    }
}
